...
title: I have installed the necessary software but the client program still
  shows 'Install'
permalink: /queries/technical/install-button/
date: 2024-02-07
layout: post
description: ""
image: ""
...
to “Installed” status as shown below. You will not be able to click again.</p>
</blockquote>
...
client program and launch it again as an administrator. If you have checked
that the software has installed successfully and able to run properly,
you may <strong><u>IGNORE</u></strong> the “Install” button status.</p>
